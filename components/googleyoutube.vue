<template>
  <v-app id="inspire" dark>
    <v-navigation-drawer v-model="drawer" fixed clipped app>
      <v-list dense>
        <v-list-tile v-for="item in items" :key="item.text" :to="item.route" v-on:click.prevent>
          <v-list-tile-action>
...
module.exports = {
  data: () => ({
    drawer: null,
    items: [
      { icon: "fa-youtube", text: "login", route: "/login" },
      { icon: "subscriptions", text: "Subscriptions", route: "/GetAllValues" },
